...
def find_best_citation():
    ...
    array_of_results = []
    arr_zakony_text, search_text, arr_id, arr_version = get_laws_for_judge_decision(decisions_text, date_decisions, 70)#treba zadat hodnotu z rozsahu 0-100
    list_best_citations = []
    ...
    print(("Pre toto: ", 70, " rozhodnutie, bol najdeny citovany zakon s id: ", id, " a vo version: ", version, ".")) #treba zadat hodnotu z rozsahu 0-100
