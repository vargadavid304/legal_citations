...
def filter_sequences(rozhodnutie, zakon):
    ...
    # nested_arrays = postupnosti_zakony
    # nested_lengths = [len(array) for array in nested_arrays]
    # #print(postupnosti_rozhodnutia, postupnosti_zakony)
...
def find_best_citation():
    ...
    for zakon in arr_zakony_text:
        ...
        zakon = remove_punctuation_and_make_3_grams(zakon)
    ...
    max_pos = find_max_position(list_best_citations, 5)
    if max_pos != None:
        id = arr_id[max_pos]
